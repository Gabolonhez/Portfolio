...
async function fetchProfileData(language) {
  const url = language === 'pt' ? './assets/data/profilePT.json' : './assets/data/profileEN.json';
...
function updateAccordionTitles(profileData) {
    ...
    document.getElementById('professionalExperience-title').textContent = titles.professionalExperience;
  }
